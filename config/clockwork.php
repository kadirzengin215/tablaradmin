...
return [
    ...
    */
    ...
    'enable' => env('CLOCKWORK_ENABLE', env('APP_DEBUG', false)),
    ...
    */
    ...
    'storage_files_path' => env('CLOCKWORK_STORAGE_FILES_PATH', storage_path('app/clockwork')),

    // Compress the metadata files using gzip, trading a little bit of performance for lower disk usage
    'storage_files_compress' => env('CLOCKWORK_STORAGE_FILES_COMPRESS', false),

    // SQL database to use, can be a name of database configured in database.php or a path to a SQLite file
    'storage_sql_database' => env('CLOCKWORK_STORAGE_SQL_DATABASE', storage_path('app/clockwork.sqlite')),
    ...
    */
    ...
    'authentication_password' => env('CLOCKWORK_AUTHENTICATION_PASSWORD', 'im-your-admin'),
